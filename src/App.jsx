        ...
        <Routes>
          ...
          <Route path="*" element={
            <div className="h-screen flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-400 text-xl">System Not Found</p>
              <a href="/" className="mt-6 text-purple-400 hover:text-white transition-colors">Return to Base</a>
            </div>
          } />
        </Routes>
      </div>
