import React from 'react'; import { motion } from 'framer-motion'; import { Server, Terminal, GitBranch, Zap, Activity, Lock, Cpu, Rocket } from 'lucide-react';

// --- ANIMATIONS --- const fadeInUp = { hidden: { y: 40, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.6 } }, };
...
);// --- FEATURE CARD --- const FeatureCard = ({ icon: Icon, title, desc }) => ( <motion.div variants={fadeInUp} whileHover={{ scale: 1.05 }} className="bg-white/[0.05] border border-white/10 p-8 rounded-3xl backdrop-blur-xl"
...
export default function Home() { return ( <div className="bg-black text-white min-h-screen font-sans relative overflow-x-hidden"> <Background /> <Navbar />
